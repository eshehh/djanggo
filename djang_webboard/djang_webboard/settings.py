"""
Django settings for djang_webboard project.
...
SECRET_KEY = "django-insecure-#f+x1$$^j#u(l&m7tda#%7o$r828=t1-voa*r*wr!+^agk*&^("
...
ROOT_URLCONF = "djang_webboard.urls"
...
WSGI_APPLICATION = "djang_webboard.wsgi.application"
